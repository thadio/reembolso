...
<div>
  <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;">
    <div>
      <h1>Cadastro de Maquininha/Sistema</h1>
      <div class="subtitle">Cadastre maquininhas e links usados para cartoes.</div>
    </div>
    <span class="pill">
      <?php echo $editing ? 'Editando #' . $esc((string) $formData['id']) : 'Nova maquininha'; ?>
    </span>
  </div>
  ...
  <form method="post" action="maquininha-cadastro.php">
    ...
    <div class="footer">
      ...
      <button class="primary" type="submit">Salvar maquininha</button>
    </div>
  </form>
</div>
